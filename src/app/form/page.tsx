            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 border border-theme rounded-md focus:outline-none focus:ring focus:ring-orange-400"
                />
              </div>
              <div>
                <label className="block text-gray-700 mb-1">
              ...
              <button
                type="submit"
                className="w-1/2 mx-auto flex justify-center items-center bg-theme text-theme font-semibold py-2 rounded-full hover:bg-orange-600 transition-all"
              >
                Submit
              </button>
            </form>
