        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2 gap-6 p-4 min-h-[550px]">
          ...
          {[0, 1].map((_, index) => (
            <div
              ...
              className={`relative ${index === 0 ? "text-black" : "text-white"}`}
            >
             
              <div
                className={`div-bg flex flex-col justify-between text-center inverted-corners ${index === 0 ? "div-bg" : "bg-blog"} rounded-2xl`}
              >
              ...
              <div
                className={`absolute right-[5px] bottom-1 h-[65px] w-[65px] rounded-[32px] flex items-center justify-center z-10 ${
                  index === 0 ? " div-bg " : "bg-theme"
                }`}
              >
                {index === 0 ? (
                  <Image
          ...
          {/* {[0, 1].map((_, index) => (
                        <div
                            ...
                            className={`div-bg flex flex-col justify-between text-center inverted-corners relative ${index == 0 ? "div-bg text-black" : "bg-blog text-[#fff]"} rounded-2xl  `}
                            // style={{
                        ...
                        >
                            ...
                            <div
                                className={`absolute bg-orange-600 z-80 bottom-[-5] right-[-5] h-[65px] w-[65px] rounded-4xl flex items-center justify-center  ${
