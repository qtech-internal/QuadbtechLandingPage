...
export default function Career() {
  ...
  return (
    <div className="  flex flex-col items-center px-4 xl:px-10  2xl:px-0 justify-cente w-full  2xl:mx-auto  2xl:w-7xl   ">
      <div className="flex flex-col md:flex-row items-center mb-4 gap-4 md:gap-44 lg:gap-74  2xl:gap-92  justify-between mt-16 w-full ">
