...
tl.to(logoRef.current, { scaleX: -1, duration: 0.2 })
  ...
  return (
    <div className="relative w-full  min-h-screen overflow-x-hidden bg-white text-black flex flex-col items-center justify-center mb-10  ">
      {/* Logo */}
  ...
  {/* Appearing Text */}
  <div ref={textRef} className="absolute mt-20 text-2xl md:text-5xl font-bold opacity-0 text-center w-full mb-4">
    ...
    <span ref={secondLineRef} className="block absolute left-[43rem] whitespace-nowrap">
      Crafting the <span className="relative inline-block px-3 border-2 border-orange-500 rounded-lg">Future of Technology</span>
  ...
  <div ref={sidebarRef} className="absolute left-0 top-10 bottom-40 w-1/4 h-auto bg-white p-5  flex flex-col items-start">
    <button className="px-4 py-2 text-sm font-bold border border-gray-300 rounded-full bg-gray-100 hover:bg-gray-200">Start Building Today</button>
    <p className="mt-4 font-semibold text-black text-left">Empowered Teams, Endless Possibilities</p>
        <div className="mt-4 flex flex-col items-center space-y-3 rounded-xl shadow-lg justify-start p-4">
