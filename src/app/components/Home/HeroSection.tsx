...
const logoRef = useRef(null);
  ...
  return (
    <div className="relative w-full max-w-[1600px]  min-h-[900px] lg:min-h-[650px] xl:min-h-[720px]  overflow-visible bg-white text-black flex flex-col items-center justify-center  2xl:mt-40  ">
      ...
      <div ref={textRef} className="absolute lg:mt-0 xl:mt-14  2xl:mt-14  text-2xl z-30 md:text-3xl lg:text-2xl xl-text-5xl  font-medium opacity-0 text-center w-full mb-4 font-poppins text-[40px] leading-[50px]   ">
{/* 
