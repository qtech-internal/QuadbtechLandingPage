...
export default function Home() {
  ...
  return (
    <div className="w-full max-w-[1500px] overflow-x-hidden text-black flex flex-col items-center justify-center p-4">
      ...
      <div
        className="text-center text-2xl  font-semibold mt-10 mb-8 font-poppins leading-[1.2]"
      ...
      >
        ...
        <span className=" flex text-center  ">
          <span className="inline-block px-3 ml-10 border-2 border-theme rounded-full">
            {" "}
          ...
          >
            <path
              d="M14.4517 5.43384C15.328 7.37721 15.6896 9.2738 15.6257 11.4503C15.6065 12.1034 15.549 12.787 15.4521 13.5098C14.5914 11.4475 13.3302 9.79201 11.6162 8.38357L14.4517 5.43384Z"
              stroke="var(--bg-card)"
              strokeWidth="5"
            />
            <path
              d="M4.5216 17.2351C5.2324 18.2581 5.70588 19.339 6.01549 20.5953C5.29124 19.919 4.48682 19.3596 3.59205 18.8967L4.5216 17.2351Z"
              stroke="var(--bg-card)"
              strokeWidth="5"
            />
          </svg>
      ...
      <div className="relative mt-10 div-bg flex flex-row items-center space-x-0 my-10 ml-0 rounded-xl shadow-lg justify-start p-4 bg-[#FFF8EB] hover:scale-110 transition-transform duration-300 ease-in-out">
        ...
        <img
          src="/home/home4.jpeg"
          alt="Person 1"
          className="w-16 h-16 rounded-full border-4 border-theme"
        />
        <img
          src="/home/home5.jpeg"
          alt="Person 2"
