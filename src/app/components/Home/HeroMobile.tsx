...
export default function Home() {
  ...
  return (
    <div className="w-full max-w-[1500px] overflow-x-hidden bg-white text-black flex flex-col items-center justify-center p-4">
      <button className="relative px-6 py-2 text-black font-medium rounded-full border border-theme bg-gradient-to-r from-[var(--div-bg)] to-transparent hover:from-[var(--div-bg)]">
        Start Building Today
      </button>
      <div className="text-center text-2xl font-semibold mt-10 mb-8 font-poppins">
         <svg width="30" height="20" className="-ml-6 translate-y-[18px]" viewBox="0 0 20 40"  fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        Crafting the <br />
        <span className="flex items-center justify-center">
          <span className="inline-block px-3 ml-8 border-2 border-theme rounded-full">Future of Technology</span>
