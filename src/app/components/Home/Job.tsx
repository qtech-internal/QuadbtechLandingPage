...
export default function Home() {
  const jobs: Job[] = [
    { title: "Blockchain Developer", location: "Remote", experience: "2+ years", imageSrc: "/bg22.png" },
    { title: "Blockchain Developer", location: "Remote", experience: "2+ years", imageSrc: "/card1 (1).svg" },
    { title: "Blockchain Developer", location: "Remote", experience: "2+ years", imageSrc: "/bg1.png" },
  ...
  return (
    <div className="min-h-screen bg-white p-4 flex flex-col items-center space-y-10 relative">
      ...
      <div
        ...
        onMouseUp={handleMouseUp}
        onMouseMove={handleMouseMove}
        className="w-full flex gap-10 overflow-hidden cursor-grab active:cursor-grabbing px-4 relative scroll-smooth"
      >
        {jobs.map((job, index) => (
          <div
            key={index}
  ...
  <div
    className="w-24 h-24 bg-white rounded-full border-1 border-orange-600 flex items-center justify-center text-[#B73B06] cursor-pointer"
  >
