...
export default function KaiFoundrySection() {
      ...
      >
        <div className="flex-1 text-center">
          ...
          <motion.div
            ...
            className="text-[#000000] text-xl font-semibold font-roboto"
          >
  ...
  <span className="border border-theme text-black px-4 py-[6px] rounded-full text-[13px] whitespace-nowrap">
    And Many More
          ...
          <button
            className="px-6 py-2 rounded-full block mx-auto button-theme mt-14 cursor-pointer"
